...
import createDesigner from '../../api/designer/createDesigner'
...
const DesignerCreate = () => {
    ...
    const onSubmit = async () => {
        const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MywidXNlcklkIjoiYWRtaW4iLCJpc0FkbWluIjpmYWxzZSwiaWF0IjoxNjA3OTkxNjgyLCJleHAiOjE2MDgwNzgwODJ9.cUrVocSDA7TDYt4QXC9wF9qHanZQYi8FMe7pes7cFpQ"
        ...
        .then(async res => {
            ...
            if (await createDesigner(name, location, fileName) === true){
